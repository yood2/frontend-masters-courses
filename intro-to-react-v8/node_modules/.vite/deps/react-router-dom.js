...
function useRevalidator() {
  ...
  !dataRouterContext ? true ? invariant(false, "useRevalidator must be used within a DataRouterContext") : invariant(false) : void 0;
...
function useFetcher() {
  var _route$matches;
  let dataRouterContext = React2.useContext(DataRouterContext);
  !dataRouterContext ? true ? invariant(false, "useFetcher must be used within a Data Router") : invariant(false) : void 0;
  let {
    router
  } = dataRouterContext;
...
function useFetchers() {
  ...
  !state ? true ? invariant(false, "useFetchers must be used within a DataRouterStateContext") : invariant(false) : void 0;
